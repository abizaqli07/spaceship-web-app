      ...
      <div className='flex gap-6'>
        <div className='w-fit px-8 py-4 flex flex-col gap-8 h-screen bg-gray-700'>
          ...
          <div className=' flex flex-col gap-4'>
            <div><Link href="/pilotdashboard">Dashboard</Link></div>
            <div><Link href="/pilotdashboard/profile">Profile</Link></div>
            <div><Link href="/pilotdashboard/schedule">Schedule</Link></div>
          </div>
          <div>
